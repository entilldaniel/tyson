...
int main(int argc, char **argv) {
  ...
  mpca_lang(MPCA_LANG_DEFAULT, GRAMMAR, Number, Symbol, Sexpr, Qexpr, Expr,
            Tyson);

  puts("Tyson Version 0.0.0.1");
  ...
  mpc_cleanup(5, Number, Symbol, Sexpr, Qexpr, Expr, Tyson);
  return 0;
}
